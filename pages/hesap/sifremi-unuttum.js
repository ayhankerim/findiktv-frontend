...
export default function SignIn({ global }) {
  ...
  const metadata = {
    id: 1,
    metaTitle: "Şifremi Unuttum | FINDIK TV",
    metaDescription:
              ...
              <div className="lg:w-10/12 md:w-9/12 xl:w-6/12 mx-auto xl:ml-0">
                ...
                {mailSend ? (
                  <div className="text-base">
                    Şifre sıfırlama bağlantınız belirtmiş olduğunuz e-posta
                    adresine{" "}
                  ...
                  <Formik
                    ...
                    onSubmit={async (
                      ...
                      try {
                        await fetchAPI(
                          `/users?filters[email][$eq]=${values.email}&filters[confirmed][$eq]=true&fields[0]=email`,
                          {},
                          {
                            method: "GET",
                          }
                          ...
                          if (data.length > 0) {
                            ...
                            notify(
                              "error",
                              "Belirttiğiniz e-posta adresiyle kayıtlı ve onaylı bir hesap yoktur. Lütfen kontrol ediniz!"
                            )
                          }
                        })
                      } catch (err) {
