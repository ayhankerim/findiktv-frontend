...
const ArticleDates = dynamic(() => import("@/components/ArticleDates"), {
  loading: () => <Loader />,
});
const PageView = dynamic(() => import("@/components/ViewCounter"), {
  loading: () => <Loader cssClass="w-[50px] lg:w-[90px] !float-right !m-0" />,
  ssr: false,
});
const ArticleShare = dynamic(() => import("@/components/ArticleShare"), {
  loading: () => <Loader />,
});
